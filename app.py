...
def main():
    ...
    with st.sidebar:
        ...
        # Add a section for importing PDF from URL
        st.subheader("Import PDF from URL")
            ...
            if pdf_url:
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        pdf_docs = [pdf_stream]  # Add the imported PDF to the list of PDFs
